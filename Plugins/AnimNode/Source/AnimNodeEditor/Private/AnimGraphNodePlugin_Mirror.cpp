#include "AnimGraphNodePlugin_Mirror.h"
...
UAnimGraphNodePlugin_Mirror::UAnimGraphNodePlugin_Mirror(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	// In UE4 CurWidgetMode = (int32)FWidget::WM_Rotate; but we don't have access to FWidget::WM_Rotate in UE5 
	CurWidgetMode = (int32)UE::Widget::EWidgetMode::WM_Rotate;
...
void UAnimGraphNodePlugin_Mirror::ValidateAnimNodeDuringCompilation(USkeleton* ForSkeleton, FCompilerResultsLog& MessageLog)
{
...
FText UAnimGraphNodePlugin_Mirror::GetControllerDescription() const
{
	return LOCTEXT("BulkTransformModifyBones", "Bulk Transform (Modify) Bones");
}

FText UAnimGraphNodePlugin_Mirror::GetTooltipText() const
{
...
FText UAnimGraphNodePlugin_Mirror::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
...
void UAnimGraphNodePlugin_Mirror::CopyNodeDataToPreviewNode(FAnimNode_Base* InPreviewNode)
{
	FAnimNodePlugin_Mirror* ModifyBone = static_cast<FAnimNodePlugin_Mirror*>(InPreviewNode);
...
FEditorModeID UAnimGraphNodePlugin_Mirror::GetEditorMode() const
{
	return AnimNodeEditModes::AnimNode;
}

void UAnimGraphNodePlugin_Mirror::CopyPinDefaultsToNodeData(UEdGraphPin* InPin)
{ }
