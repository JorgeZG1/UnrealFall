...
#include "AnimGraphNodePlugin_Mirror.generated.h"

class FCompilerResultsLog;

UCLASS(meta = (Keywords = "Modify Transform"))
class ANIMNODEEDITOR_API UAnimGraphNodePlugin_Mirror : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category = Settings)
	FAnimNodePlugin_Mirror Node;
